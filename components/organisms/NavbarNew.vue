<template>
  <div>
      <nav id="navbar" class="navbar navbar-expand-lg navbar-dark fixed-top">
        <img class="navbar-brand palas" src="~/assets/images/padang-lawas.png" width="50px" height="60px">
        <div class="logo mr-auto">
            <label for="siundol" style="font-weight:bold">E-DUMAS INSPEKTORAT</label>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto mr-5">
                ...
                <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                    <a class="nav-link js-scroll-trigger text-white" href="#">PROSES</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger text-white" href="/dumasinspektoratpalas/news">BERITA</a>
                </li>
                <li class="nav-item">
